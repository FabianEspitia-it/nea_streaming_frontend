  ...
  return (
    <div className={className}>
      <div className="flex flex-col items-center">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full rounded-full bg-[#229ED9] animate-ping" />
      ...
      <div className="flex flex-col items-center">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full rounded-full bg-[#00FF00] animate-ping" />
          <div className="relative z-10">
            <WhatsAppIcon />
          </div>
        </a>
