      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center gap-8">
          <div className="flex flex-col items-center">
            ...
            <p className="text-white text-sm mt-2">Contáctanos por WhatsApp</p>
          </div>

          <div className="flex flex-col items-center">
            <a
              href="https://www.whatsapp.com/channel/0029VatDWQr1dAvy3ZZ28N1y"
              target="_blank"
              rel="noreferrer noopener"
              className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#00FF00] relative"
            >
            ...
            <p className="text-white text-sm mt-2">¡Únete a nuestro canal!</p>
          </div>
        </div>
      </div>
    </footer>
